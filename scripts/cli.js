...
const contractABI = require("../artifacts/contracts/Compassshard.sol/Compassshard.json").abi;

program
    .name("compassshard-cli")
    .description("CLI tool for Compassshard smart contract")
    .version("1.0.0");
